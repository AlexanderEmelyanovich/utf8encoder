...
class EncoderApp(App):
    def build(self):
        ...
        result_label.bind(size=lambda l, s: l.__setattr__("text_size", (s[0], None)))
        ...
        self.result_text.bind(
            width=lambda _, w: self.result_text.__setattr__("height", self.result_text.minimum_height),
            texture_size=lambda _, ts: self.result_text.__setattr__("height", max(ts[1], result_scroll.height))
        )
